...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ ' [web] ', 2, 3, 4, ' [system] ' }, s, layouts[1])
end
-- }}}
...
vicious.register(bat_widget, vicious.widgets.bat, " [b $2 min] ", 32, "BAT1")
...
vicious.register(memwidget, vicious.widgets.mem, " [m $1%] ",
     13)
--      
